...
st.markdown(
    ...
    .profile-area-scroll::-webkit-scrollbar {
      width: 10px;
      height: 10px;
    }
    .profile-area-scroll::-webkit-scrollbar-thumb {
      background: #c8c8c8;
      border-radius: 999px;
      border: 2px solid transparent;
      background-clip: padding-box;
    }
    .profile-area-scroll::-webkit-scrollbar-track {
      background: #f3f3f3;
      border-radius: 999px;
    }
    .options-bottom-bar {
...
include_z_climb = bool(st.session_state.get("include_z_climb_flag", True))
emphasize_caps = bool(st.session_state.get("emphasize_caps_flag", False))
travel_mode = st.session_state.get("paths_travel_mode", "solid") if e_on else "solid"
prev_mode = st.session_state.get("paths_travel_mode", "solid")
dims_placeholder = st.empty()


with center_col:
    st.markdown('<div class="profile-area-scroll">', unsafe_allow_html=True)
    st.markdown("""
    <style>
